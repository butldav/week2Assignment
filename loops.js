...
for(i = 0; i <= 100; i++) {
    ...
    if(i % 3 == 0 && i % 5 == 0) { // Print HelloWorld if number divisible by both 3 and 5
        outputText = 'HelloWorld';
    } else if(i % 3 == 0 && i % 5 != 0) {   // Print Hello if number divisible by 3 only
        outputText = 'Hello';
    } else if(i % 5 == 0 && i % 3 != 0) {   // Print World if number divisible by 5 only
        outputText = 'World';
    } else {
        outputText = i;
    }
